...
public class GraphStuff extends ApplicationFrame {
    ...
    public GraphStuff(int floor, int option, String applicationTitle, String chartTitle, String sideCat, String botCat, LinkedList e1Data, LinkedList e2Data, int walkedAway, LinkedList<GraphPassTimeTest> passTime) {
        ...
        Arrays.sort(time); //Sort the time based on the short to longest

        //Get total time execution for this program.
        ...
        for (int i = 0; i < passTime.size(); i++) {
            ...
            double getNanoSeconds = (double) passTime.get(i).getTime() / 1_000_000_000;
        ...
        for(int i = 0; i < time.length; i++){
            totalTimeTaken = totalTimeTaken + time[i];
        }
        ...
        switch (option) {
            ...
            case 2:
                JLabel e1Pass, e2Pass, totalPassLbl, totalPassLblAndWA, walkedAwayPassengers, lblTimeTaken;
                JPanel panel = new JPanel();
                panel.add(new JSeparator());
                //Time Taken
                lblTimeTaken = new JLabel("Total Time Taken for Elevator Operations to Finish:  " + totalTimeTaken, SwingConstants.CENTER);
                lblTimeTaken.setAlignmentX(JLabel.CENTER_ALIGNMENT);
                ...
                walkedAwayPassengers = new JLabel("Total Passengers (Arrived Unsuccessfully):  " + walkedAway, SwingConstants.CENTER);
            ...
            case 3:
                {
                    JFreeChart barChart = ChartFactory.createBarChart(
                            ...
                            botCat,
                            sideCat,
                            postElevatorSummary(walkedAway, e1Data, e2Data, totalTimeTaken),
                            PlotOrientation.VERTICAL,
                            true, true, false);
                    ChartPanel chartPanel = new ChartPanel(barChart);
                    chartPanel.setPreferredSize(new java.awt.Dimension(560, 367));
...
//        //Put passenger/time class array nano time value in the time array so we can sort it
    ...
    private CategoryDataset postElevatorSummary(int walkedAway, LinkedList e1, LinkedList e2, double totalTimeTaken) {
        ...
        String walkedAwayPass = "Total Passengers (Arrived Unsuccessfully)";
        String e1Data = "Elevator 1 Passengers";
        String e2Data = "Elevator 2 Passengers";
        String timeTaken = "Total Time Taken";
        //Create dataset for the elevators
        ...
        dataset.addValue((double) totalTimeTaken, timeTaken, "");
